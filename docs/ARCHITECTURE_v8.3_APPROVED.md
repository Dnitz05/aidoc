...
|---------|--------------|-----|
| **Model LLM** | **gemini-2.5-flash-lite (OBLIGATORI)** | **Ràpid, sense thinking, obligatori per tot** |
...
> ⚠️ **IMPORTANT**: Sempre usar `gemini-2.5-flash-lite` per classifier i executor. NO usar gemini-2.5-flash (té thinking i és lent).
