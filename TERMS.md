...
The Service uses artificial intelligence to process your instructions and modify document text accordingly.
...
Access to the Service requires a valid license key. You are responsible for:
- Keeping your license key confidential
- All activity that occurs under your license key
- Notifying us immediately of any unauthorized use

### 3.3 Credits System

The Service operates on a credit-based system:
- Each AI operation consumes credits from your account
- Credits are non-refundable once used
- Unused credits may expire according to your subscription plan
...
- Automate requests in a way that overloads our servers
...
- AI-generated suggestions may contain errors or inaccuracies
- The AI may produce unexpected or inappropriate results
- You are responsible for reviewing and approving all changes
- AI output should not be relied upon for legal, medical, or financial advice

### 5.2 Your Responsibility

You retain full responsibility for:
- All content in your documents, whether AI-assisted or not
- Verifying the accuracy of AI suggestions before accepting them
- Ensuring your use of AI-generated content complies with applicable laws
- Any consequences arising from publishing or sharing AI-assisted content

### 5.3 No Guarantee

We do not guarantee that AI suggestions will:
...
You retain all rights to your original document content. By using the Service, you grant us a limited license to process your content solely to provide the Service.

### 6.3 AI Output

Content generated or modified by the AI at your request becomes part of your document. You may use this content as you see fit, subject to Section 5.

---

## 7. Privacy

Your use of the Service is also governed by our Privacy Policy, which is incorporated into these Terms by reference. Please review our Privacy Policy to understand how we handle your information.
...
- Update pricing and credit costs
...
- Payment is due according to your chosen billing cycle
...
- Contact us if you believe you are entitled to a refund
...
- We are not liable for any loss or corruption of your documents
...
- Removing the Add-on from Google Docs
- Discontinuing use of your license key
...
- We may delete your stored data after 30 days
...
These Terms are governed by the laws of Spain, without regard to conflict of law principles. Any disputes shall be resolved in the courts of Barcelona, Spain.
